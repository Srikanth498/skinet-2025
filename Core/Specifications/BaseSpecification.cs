...
{
    protected BaseSpecification() : this(null){} // default constructor to set criteria to null if not provided in the constructor 
    ...
    public IQueryable<T> ApplyCritiria(IQueryable<T> query)
    {
        if(Criteria != null)
        {
